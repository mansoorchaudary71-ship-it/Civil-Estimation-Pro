...
files.forEach(file => {
  ...
  newContent = newContent.replace(/text-slate-[3456]00(.*?)uppercase tracking-[A-Za-z-]*(.*?)(Estimate Results|Estimate Parameters|Review Breakdown|Calculation Methodology|Calculation Breakdown)/gi, (match, p1, p2, p3) => {
