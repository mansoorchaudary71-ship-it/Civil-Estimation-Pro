...
import { ConcreteMortarCalculator, BrickworkCalculator } from "./src/utils/calculators.js";
...
async function startServer() {
  ...
  app.post("/api/estimate", async (req, res) => {
    try {
      ...
      res.json({ role: "model", content: finalContext });
