        ...
        <div className="flex flex-1 min-h-0 relative w-full">
          ...
          <main id="main-content" className="flex-1 flex flex-col bg-transparent relative w-full min-h-0 md:px-6 md:pb-6 md:pt-4 transition-all duration-300">
            ...
            <div className="flex-1 flex flex-col min-h-0 relative w-full bg-transparent pb-40 md:pb-32">
              ...
              {activeModule === "chainage" && <ModuleWrapper title="Chainage Volume" activeModule={activeModule} setActiveModule={handleSelectModule} setIsSidebarOpen={setIsSidebarOpen} setIsSettingsOpen={setIsSettingsOpen}><ChainageVolumeEstimator /></ModuleWrapper>}
              ...
              {activeModule === "aggregate-blending" && <ModuleWrapper title="Aggregate Blending" activeModule={activeModule} setActiveModule={handleSelectModule} setIsSidebarOpen={setIsSidebarOpen} setIsSettingsOpen={setIsSettingsOpen}><AggregateBlendingCalculator /></ModuleWrapper>}
              {activeModule === "direct-shear" && <ModuleWrapper title="Direct Shear Test" activeModule={activeModule} setActiveModule={handleSelectModule} setIsSidebarOpen={setIsSidebarOpen} setIsSettingsOpen={setIsSettingsOpen}><DirectShearTestCalculator /></ModuleWrapper>}
                ...
                >
                  ...
                  {moduleDef && (
                    <>
                      ...
                      <DiscussionWidget moduleId={moduleDef.id} toolName={moduleDef.title} />
                    </>
                  )}
                </div>
              );
