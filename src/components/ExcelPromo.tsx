  ...
  if (isSubmitted) {
    return (
      <div className="w-full max-w-[1400px] mx-auto px-4 lg:px-8 mb-20 animate-in fade-in duration-500">
        <div className="bg-gradient-to-br from-yellow-400 to-amber-500 rounded-[2rem] p-8 md:p-16 text-center text-gray-900 shadow-2xl relative overflow-hidden">
          ...
          <div className="relative z-10 flex flex-col items-center">
            ...
            <h2 className="md: tabular-nums mb-4 uppercase drop-shadow-md text-xl font-semibold text-gray-900 tracking-tight">
              Success! Check your Email
            </h2>
            <p className="md: text-amber-900 mb-8 max-w-xl mx-auto text-base font-normal text-gray-600 leading-relaxed">
              Your free Excel Estimation Pack has been sent to your email and WhatsApp. Happy Estimating!
            </p>
            <button 
              onClick={() => setIsSubmitted(false)}
              className="px-6 py-2 bg-slate-50/10 hover:bg-slate-50/20 text-gray-900 font-bold rounded-[16px] transition-colors"
            >
              Back to Form
            </button>
          </div>
    ...
    <div className="w-full max-w-[1400px] mx-auto px-4 lg:px-8 mb-20">
      <div className="bg-gradient-to-br from-[#ffd700] via-[#ffb900] to-[#ffaa00] rounded-[2.5rem] p-1 md:p-2 shadow-[0_20px_50px_rgba(255,170,0,0.3)] relative overflow-hidden group">
        <div className="absolute top-0 right-0 p-8 opacity-20 pointer-events-none transition-transform duration-700 group-hover:scale-110 group-hover:rotate-12">
          <FileSpreadsheet className="w-64 h-64 text-gray-900" />
        </div>
        ...
        <div className="bg-white/95 backdrop-blur-2xl rounded-[2.2rem] p-6 md:p-10 lg:p-12 relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
          ...
          <div className="space-y-8">
            <div>
              <div className="inline-flex items-center gap-2 bg-gradient-to-r from-amber-500 to-orange-500 text-gray-900 font-semibold tabular-nums tracking-tight uppercase tracking-wider text-xs px-4 py-1.5 rounded-full mb-6 shadow-md shadow-orange-500/20">
                <Gift className="w-4 h-4" /> 100% Free Download
              </div>
              <h2 className="md: tabular-nums leading-tight mb-4 drop-shadow-sm text-xl font-semibold text-gray-900 tracking-tight">
                Get the Ultimate <br className="hidden md:block"/>
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-500 to-orange-600">
                  Excel Estimation Pack
                </span>
              </h2>
              <p className="drop-shadow-sm text-base font-normal text-gray-600 leading-relaxed">
          ...
          <div className="bg-slate-50/80 backdrop-blur-xl rounded-[24px] p-6 md:p-8 border border-slate-200 shadow-xl relative">
            ...
            <div className="mb-6 text-center">
              <h3 className="mb-2 text-lg font-medium text-gray-800 mb-4">Where should we send it?</h3>
              <p className=" text-base font-normal text-gray-600 leading-relaxed">Delivered instantly via Email & WhatsApp.</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <input 
                    ...
                    className="w-full bg-white border border-slate-200 rounded-[24px] py-3 pl-10 pr-4 outline-none focus:ring-2 focus:ring-amber-500 font-medium text-gray-900 placeholder:text-gray-600"
                  />
                </div>
              </div>
              ...
              <button 
                type="submit" 
                className="w-full bg-gradient-to-r from-orange-500 to-amber-500 hover:from-orange-400 hover:to-amber-400 text-gray-900 tabular-nums tracking-tight py-4 rounded-[24px] flex items-center justify-center gap-2 shadow-[0_8px_30px_rgba(249,115,22,0.3)] hover:shadow-[0_8px_40px_rgba(249,115,22,0.5)] transition-all hover:-translate-y-1 active:scale-95 border border-white/10 mt-4 text-base font-semibold"
              >
                <Download className="w-6 h-6" />
                GET FREE EXCEL PACK
              </button>
              <p className="text-center mt-4 text-base font-normal text-gray-600 leading-relaxed">
