    ...
    <div className="flex-1 overflow-y-auto px-4 md:px-8 py-6 md:py-10 pb-12 w-full max-w-7xl mx-auto">
      <div className="mb-6 flex justify-between items-center px-1">
        <div className="flex items-center gap-3">
          <button onClick={onOpenSidebar} className="p-2 -ml-2 rounded-full hover:bg-gray-200 text-gray-700 bg-gray-100 md:hidden">
          ...
          <div>
            ...
            <p className="text-gray-500 font-medium mt-1 text-sm">Select an estimator module</p>
          </div>
        </div>
        {onOpenSettings && (
          <button 
            onClick={onOpenSettings} 
            className="p-3 rounded-2xl bg-white border border-gray-200 hover:border-gray-300 hover:bg-gray-50 text-gray-600 shadow-sm transition-all flex items-center justify-center gap-2 font-semibold text-sm"
          >
      ...
      <div className="mb-8 relative group">
        ...
        <input 
          ...
          className="w-full bg-white border border-gray-200 focus:border-blue-500 rounded-3xl py-4 flex-1 pl-12 pr-4 text-sm font-semibold text-gray-800 shadow-sm focus:shadow-md focus:ring-4 focus:ring-blue-500/10 outline-none transition-all placeholder:text-gray-400 placeholder:font-medium"
        />
      </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 md:gap-6">
        ...
        <button 
          ...
          className="col-span-2 lg:col-span-2 relative bg-white p-6 md:p-8 rounded-[32px] border border-gray-100 flex justify-between items-center text-left hover:-translate-y-1 hover:shadow-[0_20px_40px_-15px_rgba(0,0,0,0.05)] transition-all overflow-hidden group"
        >
          <div className="absolute top-0 left-0 w-64 h-64 bg-green-500/5 rounded-full blur-3xl -ml-20 -mt-20 group-hover:scale-110 transition-transform" />
          <div className="relative z-10">
            <div className="text-xs font-bold text-green-600 uppercase tracking-widest mb-1.5 flex items-center gap-1.5"><PencilRuler className="w-4 h-4"/> 2D TAKEOFF</div>
            <div className="text-2xl font-black text-gray-900 mb-1">Plan Measure</div>
            <p className="text-sm font-medium text-gray-500">Area & Linear extraction</p>
          </div>
          <div className="relative z-10 w-16 h-16 rounded-2xl bg-green-50 flex items-center justify-center text-green-600 group-hover:bg-green-500 group-hover:text-white transition-colors duration-300">
        ...
        >
          ...
          <div className="relative z-10 w-10 h-10 rounded-xl bg-amber-50 text-amber-500 flex items-center justify-center mb-4 group-hover:bg-amber-500 group-hover:text-white transition-colors duration-300">
             <Truck className="w-5 h-5" />
          </div>
          <div className="relative z-10 mt-auto">
             <div className="text-[10px] font-bold text-amber-500 uppercase tracking-widest mb-1">SITE PREP</div>
             <div className="text-base font-black text-gray-900 leading-tight">Earthworks</div>
          </div>
        </button>
        )}
        ...
        <button 
          ...
          className="col-span-1 relative bg-white p-5 rounded-[28px] border border-gray-100 flex flex-col justify-between text-left hover:-translate-y-1 hover:shadow-[0_20px_40px_-15px_rgba(0,0,0,0.05)] transition-all overflow-hidden group min-h-[160px]"
        >
          <div className="absolute top-0 right-0 w-32 h-32 bg-slate-500/5 rounded-full blur-2xl -mr-10 -mt-10" />
          <div className="relative z-10 w-10 h-10 rounded-xl bg-slate-50 text-slate-500 flex items-center justify-center mb-4 group-hover:bg-slate-500 group-hover:text-white transition-colors duration-300">
             <Route className="w-5 h-5" />
          </div>
          <div className="relative z-10 mt-auto">
             <div className="text-[10px] font-bold text-slate-500 uppercase tracking-widest mb-1">INFRASTRUCTURE</div>
             <div className="text-base font-black text-gray-900 leading-tight">Road Estimator</div>
          </div>
        </button>
        )}
        ...
        >
          ...
          <div className="relative z-10 w-10 h-10 rounded-xl bg-cyan-50 text-cyan-500 flex items-center justify-center mb-4 group-hover:bg-cyan-500 group-hover:text-white transition-colors duration-300">
             <Waves className="w-5 h-5" />
          </div>
          <div className="relative z-10 mt-auto">
             <div className="text-[10px] font-bold text-cyan-500 uppercase tracking-widest mb-1">UTILITIES</div>
             <div className="text-base font-black text-gray-900 leading-tight">Sewerage &<br/>Drainage</div>
          </div>
        </button>
        )}
        ...
        >
          ...
          <div className="relative z-10 w-10 h-10 rounded-xl bg-fuchsia-50 text-fuchsia-500 flex items-center justify-center mb-4 group-hover:bg-fuchsia-500 group-hover:text-white transition-colors duration-300">
             <Paintbrush className="w-5 h-5" />
          </div>
          <div className="relative z-10 mt-auto">
             <div className="text-[10px] font-bold text-fuchsia-500 uppercase tracking-widest mb-1">INTERIORS</div>
             <div className="text-base font-black text-gray-900 leading-tight">Finishing works</div>
          </div>
        </button>
        )}
        ...
        >
          ...
          <div className="relative z-10 w-10 h-10 rounded-xl bg-violet-50 text-violet-500 flex items-center justify-center mb-4 group-hover:bg-violet-500 group-hover:text-white transition-colors duration-300">
             <Hammer className="w-5 h-5" />
          </div>
          <div className="relative z-10 mt-auto">
             <div className="text-[10px] font-bold text-violet-500 uppercase tracking-widest mb-1">STRUCTURAL</div>
             <div className="text-base font-black text-gray-900 leading-tight">Formwork &<br/>Scaffold</div>
          </div>
        </button>
        )}
