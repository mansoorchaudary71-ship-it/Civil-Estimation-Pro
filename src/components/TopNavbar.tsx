...
export default function TopNavbar({
  ...
  return (
    <header className="w-full sticky top-0 left-0 right-0 z-[120] bg-white/70 backdrop-blur-xl border-b border-slate-200/60 shadow-[0_4px_24px_rgba(0,0,0,0.02)] transition-colors overflow-hidden">
      <div className="w-full md:max-w-7xl md:mx-auto px-4 md:px-8 h-[64px] flex items-center justify-between">
