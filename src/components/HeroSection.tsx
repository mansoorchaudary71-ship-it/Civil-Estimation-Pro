      ...
      <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-8 max-w-7xl mx-auto">
        ...
        <div className="flex-1 flex flex-col items-start text-left shrink-0 max-w-2xl w-full">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4 w-full sm:w-auto mb-10">
            <button
              onClick={onStart}
              className="w-full sm:w-auto px-8 py-4 rounded-xl font-bold text-slate-900 bg-[#F59E0B] hover:bg-[#fbbf24] shadow-[0_0_20px_rgba(245,158,11,0.3)] hover:shadow-[0_0_30px_rgba(245,158,11,0.5)] transition-all text-base flex items-center justify-center gap-2 hover:-translate-y-1"
              style={{ fontFamily: "Satoshi, sans-serif" }}
            >
