  ...
  return (
    <div className="relative w-full bg-transparent overflow-hidden pt-24 md:pt-32 pb-16 flex flex-col items-center font-sans">
      ...
      <div className="md:max-w-[1200px] md:mx-auto px-4 sm:px-6 w-full relative z-10 flex flex-col items-center justify-center text-center">
        ...
        >
          {/* Badge */}
          <div className="w-full inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-white/70 backdrop-blur-md border border-white/20 shadow-sm mb-8 overflow-hidden">
            <span className="px-2 py-0.5 rounded-full bg-blue-600/10 text-blue-600 text-base font-medium uppercase tracking-wider">
              New
            </span>
          ...
          <h1 className="sm: md:text-7xl leading-[1.1] mb-6 text-xl font-semibold text-slate-800 tracking-tight">
            ...
            <span className="text-blue-600">Estimate Faster.</span>
          </h1>
        ...
        <div className="relative w-full md:max-w-5xl md:mx-auto mt-4 mb-20 flex flex-col lg:block items-center px-4 md:px-0">
          ...
          <motion.div 
            ...
            className="relative z-10 w-full md:max-w-3xl md:mx-auto scale-[0.85] sm:scale-100 origin-top mb-[-10%] sm:mb-0 px-4 md:px-0"
          >
            {/* Tablet Frame */}
                ...
                <div className="flex-1 p-4 sm:p-6 flex flex-col sm:flex-row gap-4 sm:gap-6 bg-gray-50/50">
                  ...
                  <div className="flex-1 flex flex-col gap-4">
                    ...
                    <div className="flex gap-4 h-32 sm:h-40 flex-wrap">
                      <div className="w-full flex-1 bg-white rounded-xl border border-gray-200 shadow-sm p-4 flex flex-col gap-3 overflow-hidden">
                      ...
                      <div className="w-full hidden sm:flex w-32 bg-white rounded-xl border border-gray-200 shadow-sm p-4 flex-col gap-3 justify-center items-center overflow-hidden">
          ...
          <motion.div 
            ...
            className="lg:absolute left-0 top-[20%] z-20 mt-6 lg:mt-0 lg:-ml-12 w-full max-w-[300px] lg:max-w-[280px] bg-white/70 backdrop-blur-lg border border-white/20 shadow-xl shadow-gray-200/50 hover:shadow-[0_12px_40px_rgba(59,130,246,0.15)] hover:-translate-y-1 hover:scale-105 transition-all duration-300 cursor-default rounded-3xl lg:rounded-[2rem] p-4 sm:p-5 flex flex-col text-left overflow-hidden"
          >
