      ...
      <div className="max-w-7xl mx-auto px-4 pt-12 md:pt-20 pb-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 mb-20">
          ...
          <div className="lg:col-span-7 flex flex-col gap-6">
            <div className="bg-[#FFFFFF] border border-slate-200 rounded-2xl p-6 md:p-8 shadow-sm">
          ...
          <div className="lg:col-span-5 h-full">
            <div className="bg-gradient-to-b from-[#152136] to-[#FFFFFF] border border-amber-500/20 rounded-3xl p-8 sticky top-28 shadow-xl flex flex-col h-full">
           ...
           <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
              {[
                ...
                { title: "Steel Weight Estimator", desc: "Calculate precise rebar weights & lengths.", icon: Grid, target: "#" }
                 ...
                 <a key={idx} href={tool.target} className="bg-[#FFFFFF] border border-slate-200 hover:border-amber-500/40 rounded-2xl p-5 group transition-all">
