      ...
      <div className="max-w-7xl mx-auto px-4 pt-12 md:pt-20 pb-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 mb-16">
          <div className="lg:col-span-7 flex flex-col gap-6">
            ...
            <div className="bg-gradient-to-br from-[#0D1525] to-[#152136] border border-slate-800 rounded-3xl p-6 md:p-8 shadow-2xl relative overflow-hidden">
               {/* Background Accent */}
               ...
               <div className="relative mb-6 z-10">
                 <input 
                   ...
                   className="w-full bg-[#0A0F1E]/80 border-2 border-slate-700/50 focus:border-amber-500 rounded-2xl px-6 py-6 text-4xl md:text-6xl font-black text-white focus:outline-none transition-all shadow-inner"
                   placeholder="0"
                 />
               </div>
                 ...
                 <div className="flex flex-wrap gap-2">
                    {[
                      ...
                      <button 
                        ...
                        className="px-3 py-1.5 rounded-lg border border-slate-700/40 bg-slate-800/30 text-slate-300 text-xs font-semibold hover:border-amber-500/50 hover:bg-amber-500/10 transition-colors"
                      >
                        {btn.label}
                      </button>
                    ))}
            ...
            <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-2 gap-3 h-full">
               {allUnits.map(u => {
                 ...
                 return (
                   <div 
                     key={u} 
                     className={`flex flex-col justify-center p-5 rounded-2xl border transition-all ${isSource ? 'bg-amber-500/5 border-amber-500/60 shadow-lg' : 'bg-[#0D1525] border-slate-800'}`}
                   >
                     <span className="text-xs uppercase tracking-widest font-bold text-slate-500 mb-1">{u}</span>
                     <span className={`text-xl md:text-2xl font-black ${isSource ? 'text-amber-500' : 'text-white'}`}>
        ...
        {/* Funnel CTA */}
        <a href="/calculators/quantity-estimation/house-construction-cost-calculator" className="block max-w-4xl mx-auto mb-20 bg-gradient-to-r from-amber-500 to-amber-600 rounded-3xl p-6 md:p-8 hover:shadow-[0_0_40px_rgba(245,158,11,0.3)] transition-all transform hover:-translate-y-1">
        ...
        <div className="mb-20">
           <h2 className="text-2xl md:text-3xl font-bold text-white mb-6 border-b border-slate-800/60 pb-4">
              ...
              <table className="w-full text-left text-sm text-slate-300">
                ...
                <tbody className="divide-y divide-slate-800/60">
                  <tr className="hover:bg-slate-800/30 transition-colors">
                    <td className="px-6 py-4 font-bold text-white">1 Marla</td>
                  ...
                  <tr className="hover:bg-slate-800/30 transition-colors bg-[#0D1525]/30">
                    <td className="px-6 py-4 font-bold text-white">1 Kanal (20 Marlas)</td>
                  ...
                  <tr className="hover:bg-slate-800/30 transition-colors">
                    <td className="px-6 py-4 font-bold text-white">1 Acre (8 Kanals)</td>
                  ...
                  <tr className="hover:bg-slate-800/30 transition-colors bg-[#0D1525]/30">
                    <td className="px-6 py-4 font-bold text-white">1 Murabba (25 Acres)</td>
