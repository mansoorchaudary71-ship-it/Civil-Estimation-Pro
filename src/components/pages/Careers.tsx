...
export default function Careers() {
  return (
    <div className="w-full max-w-4xl mx-auto space-y-12 pb-12 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      {/* Empty State */}
      <div className="bg-bg-card rounded-[3rem] p-10 md:p-16 border border-border-color shadow-sm text-center relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-xl mx-auto flex flex-col items-center">
          ...
          <div className="w-full bg-bg-primary/50 rounded-3xl p-8 border border-border-color/50 flex flex-col items-center text-center shadow-inner">
            <div className="w-12 h-12 bg-bg-card rounded-2xl flex items-center justify-center shadow-sm border border-border-color mb-5">
