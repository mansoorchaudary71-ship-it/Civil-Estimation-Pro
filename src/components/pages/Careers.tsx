    ...
    <div className="w-full max-w-4xl mx-auto space-y-12 pb-12 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="bg-bg-card rounded-[3rem] p-10 md:p-16 border border-slate-200 dark:border-slate-700 shadow-sm text-center relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-xl mx-auto flex flex-col items-center">
          ...
          <div className="w-full bg-white dark:bg-slate-800/50 rounded-3xl p-8 border border-slate-200 dark:border-slate-700/50 flex flex-col items-center text-center shadow-inner">
            <div className="w-12 h-12 bg-bg-card rounded-2xl flex items-center justify-center shadow-sm border border-slate-200 dark:border-slate-700 mb-5">
            ...
            <a 
              ...
              className="inline-flex items-center gap-2 px-8 py-3.5 bg-slate-900 border border-slate-800 dark:bg-white dark:border-white text-slate-900 dark:text-white font-bold rounded-xl hover:bg-slate-800 dark:hover:bg-slate-100 transition-all shadow-md hover:shadow-lg w-full md:w-auto justify-center"
            >
