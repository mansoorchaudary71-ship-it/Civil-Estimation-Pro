...
export default function AboutUs() {
  return (
    <div className="w-full max-w-5xl mx-auto space-y-16 pb-16 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      {/* Story / Background */}
      <div className="bg-white dark:bg-slate-900 rounded-[2.5rem] p-8 md:p-12 border border-slate-200 dark:border-slate-800 shadow-sm relative overflow-hidden">
        <div className="absolute top-0 right-0 p-16 opacity-5 pointer-events-none">
          <Building2 className="w-64 h-64 text-slate-900 dark:text-white" />
        </div>
        <div className="relative z-10 max-w-3xl">
          <h2 className="text-2xl md:text-3xl font-bold text-slate-800 dark:text-white mb-6">Our Story</h2>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
        <div className="bg-gradient-to-b from-blue-50 to-white dark:from-blue-950/20 dark:to-slate-900 rounded-3xl p-6 md:p-8 text-center border border-blue-100 dark:border-blue-900/30 shadow-sm flex flex-col items-center justify-center transition-transform hover:-translate-y-1 duration-300">
          <div className="w-12 h-12 bg-white dark:bg-slate-800 rounded-2xl shadow-sm flex items-center justify-center mb-5 border border-blue-100 dark:border-slate-700">
            <Zap className="w-6 h-6 text-blue-500" />
          </div>
          <div className="text-4xl font-extrabold text-slate-800 dark:text-white mb-2">25+</div>
        ...
        <div className="bg-gradient-to-b from-teal-50 to-white dark:from-teal-950/20 dark:to-slate-900 rounded-3xl p-6 md:p-8 text-center border border-teal-100 dark:border-teal-900/30 shadow-sm flex flex-col items-center justify-center transition-transform hover:-translate-y-1 duration-300">
          <div className="w-12 h-12 bg-white dark:bg-slate-800 rounded-2xl shadow-sm flex items-center justify-center mb-5 border border-teal-100 dark:border-slate-700">
            <Users className="w-6 h-6 text-teal-500" />
          </div>
          <div className="text-4xl font-extrabold text-slate-800 dark:text-white mb-2">500+</div>
          <div className="text-xs md:text-sm font-bold text-slate-500 dark:text-slate-400 uppercase tracking-widest">Engineers</div>
        </div>
        
        <div className="bg-gradient-to-b from-slate-50 to-white dark:from-slate-800/50 dark:to-slate-900 rounded-3xl p-6 md:p-8 text-center border border-slate-200 dark:border-slate-800/50 shadow-sm flex flex-col items-center justify-center transition-transform hover:-translate-y-1 duration-300">
          <div className="w-12 h-12 bg-white dark:bg-slate-800 rounded-2xl shadow-sm flex items-center justify-center mb-5 border border-slate-200 dark:border-slate-700">
          ...
          <div className="text-4xl font-extrabold text-slate-800 dark:text-white mb-2">10x</div>
