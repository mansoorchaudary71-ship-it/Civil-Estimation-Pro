  ...
  return (
    <div className="max-w-6xl mx-auto space-y-12 pb-12 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="text-center space-y-4 pt-4 md:pt-8 bg-white/50 dark:bg-slate-900/50 p-8 md:p-12 rounded-[3rem]">
        <div className="inline-flex items-center justify-center w-16 h-16 rounded-3xl bg-blue-100/50 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 mb-4 shadow-[0_8px_16px_-6px_rgba(37,99,235,0.2)]">
      ...
      <div className="flex flex-col lg:flex-row gap-8 lg:gap-12 relative">
        ...
        <aside className="w-full lg:w-72 shrink-0 lg:sticky top-24 self-start">
          ...
          <div className="mt-6 bg-slate-50 dark:bg-slate-900/50 p-6 rounded-3xl border border-slate-200/60 dark:border-slate-800/60 text-sm">
            ...
            <button 
              ...
              className="text-blue-600 dark:text-blue-400 font-bold hover:underline mt-2 inline-flex items-center gap-1.5"
            >
        ...
        <main className="flex-1 bg-white dark:bg-slate-900 p-8 md:p-12 lg:p-16 rounded-[2.5rem] border border-slate-200 dark:border-slate-800 shadow-sm min-w-0">
          <div className="prose prose-slate dark:prose-invert prose-lg max-w-none prose-headings:font-bold prose-headings:tracking-tight prose-a:text-blue-600 dark:prose-a:text-blue-400 transition-colors">
