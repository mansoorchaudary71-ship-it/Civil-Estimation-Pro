...
export default function Footer({ activeModule, onNavigate }: { activeModule?: ModuleId, onNavigate?: (id: ModuleId) => void }) {
  ...
  return (
    <footer className="relative w-full overflow-hidden shrink-0 z-20 bg-[#0A0F1E] border-t border-amber-500/20 pt-16 pb-8 mt-auto shadow-[inset_0_1px_20px_rgba(245,158,11,0.05)] text-slate-300" style={{ fontFamily: "'Inter', sans-serif" }}>
      <div className="relative z-10 w-full max-w-7xl mx-auto px-6 md:px-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-12 md:gap-8 mb-16">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 col-span-1 md:col-span-3 gap-8 md:gap-6">
            ...
            <div className="flex flex-col gap-4">
              <h3 className="text-[11px] font-bold text-amber-500 uppercase tracking-widest mb-2">Tools</h3>
              <div className="flex flex-col gap-3">
                {[
                  ...
                  <button 
                    ...
                    className="group relative text-left text-sm text-slate-400 hover:text-amber-500 transition-colors w-fit"
                  >
            ...
            {/* Company Column */}
            <div className="flex flex-col gap-4">
              <h3 className="text-[11px] font-bold text-amber-500 uppercase tracking-widest mb-2">Company</h3>
              <div className="flex flex-col gap-3">
                {['About Us', 'Careers', 'Contact', 'Blog'].map((link) => (
                  <button key={link} className="group relative text-left text-sm text-slate-400 hover:text-amber-500 transition-colors w-fit">
            ...
            {/* Legal Column */}
            <div className="flex flex-col gap-4">
              <h3 className="text-[11px] font-bold text-amber-500 uppercase tracking-widest mb-2">Legal</h3>
              <div className="flex flex-col gap-3">
            ...
            {/* Resources Column */}
            <div className="flex flex-col gap-4">
              <h3 className="text-[11px] font-bold text-amber-500 uppercase tracking-widest mb-2">Resources</h3>
              <div className="flex flex-col gap-3">
        ...
        {/* Email Capture Bar */}
        <div className="w-full bg-slate-900/50 border border-slate-800 rounded-2xl p-6 md:p-8 mb-10 flex flex-col md:flex-row items-center justify-between gap-6 shadow-inner">
          <div className="flex flex-col items-center md:items-start text-center md:text-left gap-1">
            <h3 className="text-lg font-bold text-white flex items-center gap-2">
              <MailPlus className="w-5 h-5 text-amber-500" /> Stay Updated
            </h3>
          ...
          <div className="flex w-full md:w-auto relative max-w-md">
            <input 
              ...
              className="w-full md:w-80 bg-[#0A0F1E] border border-slate-700/50 rounded-xl py-3 pl-4 pr-32 text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent transition-all"
            />
            <button 
        ...
        <div className="pt-8 border-t border-slate-800/80 flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-4">
            <a href="#" className="flex items-center gap-2 text-slate-500 hover:text-amber-500 transition-colors group">
              <span className="w-9 h-9 rounded-full bg-slate-800/50 group-hover:bg-amber-500/10 flex items-center justify-center transition-colors">
