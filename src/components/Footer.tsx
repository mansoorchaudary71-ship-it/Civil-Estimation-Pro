...
export default function Footer({ activeModule, onNavigate }: { activeModule?: ModuleId, onNavigate?: (id: ModuleId) => void }) {
  ...
  return (
    <footer className="relative w-full overflow-hidden shrink-0 z-20 bg-slate-900 border-t-4 border-orange-500 pt-16 pb-8 mt-auto shadow-sm text-slate-300" style={{ fontFamily: "'Inter', sans-serif" }}>
      <div className="relative z-10 w-full max-w-7xl mx-auto px-6 md:px-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-12 md:gap-8 mb-16">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 col-span-1 md:col-span-3 gap-8 md:gap-6">
            ...
            <div className="flex flex-col gap-4">
              <h3 className="text-[11px] font-bold text-orange-500 uppercase tracking-widest mb-2">Tools</h3>
              <div className="flex flex-col gap-3">
                {[
                  ...
                  <button 
                    ...
                    className="group relative text-left text-sm text-slate-400 hover:text-orange-500 transition-colors w-fit"
                  >
                    <span className="relative z-10">{link.name}</span>
                    <span className="absolute left-0 bottom-[-2px] w-0 h-[1px] bg-orange-500 transition-all duration-300 group-hover:w-full"></span>
                  </button>
                ))}
              </div>
            </div>
            ...
            {/* Company Column */}
            <div className="flex flex-col gap-4">
              <h3 className="text-[11px] font-bold text-orange-500 uppercase tracking-widest mb-2">Company</h3>
              <div className="flex flex-col gap-3">
                {['About Us', 'Careers', 'Contact', 'Blog'].map((link) => (
                  <button key={link} className="group relative text-left text-sm text-slate-400 hover:text-orange-500 transition-colors w-fit">
            ...
            {/* Legal Column */}
            <div className="flex flex-col gap-4">
              <h3 className="text-[11px] font-bold text-orange-500 uppercase tracking-widest mb-2">Legal</h3>
              <div className="flex flex-col gap-3">
            ...
            {/* Resources Column */}
            <div className="flex flex-col gap-4">
              <h3 className="text-[11px] font-bold text-orange-500 uppercase tracking-widest mb-2">Resources</h3>
              <div className="flex flex-col gap-3">
        ...
        <div className="w-full bg-slate-800/50 border border-slate-700/50 rounded-2xl p-6 md:p-8 mb-10 flex flex-col md:flex-row items-center justify-between gap-6 shadow-inner">
          <div className="flex flex-col items-center md:items-start text-center md:text-left gap-1">
            <h3 className="text-lg font-bold text-white flex items-center gap-2">
              <MailPlus className="w-5 h-5 text-orange-500" /> Stay Updated
            </h3>
          ...
          <div className="flex w-full md:w-auto relative max-w-md">
            ...
            <button 
              ...
              className="absolute right-1 top-1 bottom-1 px-5 bg-orange-500 hover:bg-orange-400 text-slate-900 font-bold text-sm rounded-lg transition-colors"
            >
              Subscribe
            </button>
          </div>
        ...
        <div className="pt-8 border-t border-slate-800/80 flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-4">
            <a href="#" className="flex items-center gap-2 text-slate-500 hover:text-orange-500 transition-colors group">
              <span className="w-9 h-9 rounded-full bg-slate-800/50 group-hover:bg-orange-500/10 flex items-center justify-center transition-colors">
