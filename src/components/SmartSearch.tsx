      ...
      >
        <div className="pl-6 md:pl-8 pr-4 flex items-center justify-center h-full">
          {isSearching ? (
            ...
            <Search
              className={`w-5 h-5 md:w-6 md:h-6 transition-colors duration-300 ${isFocused || query ? "text-indigo-500" : "text-slate-400"}`}
            />
          )}
        </div>
        <input
        ...
        {!query && !isFocused && (
          <div className="hidden md:flex items-center justify-center mr-4">
            <span className="flex items-center justify-center w-6 h-6 rounded bg-slate-100 border border-slate-200 text-slate-400 text-xs font-bold font-mono">
              /
            </span>
          </div>
        )}
        ...
        <div className="mr-3 pr-2 flex items-center gap-2">
          ...
          <button
            ...
            className={`p-3 rounded-full transition-all duration-300 ${isListening ? "bg-red-50 text-red-500 shadow-[0_0_15px_rgba(239,68,68,0.3)] animate-pulse" : "hover:bg-indigo-50 text-slate-400 hover:text-indigo-500"}`}
          >
      ...
      <AnimatePresence>
        {showDropdown && (
          <motion.div
            ...
            className="absolute top-[calc(100%+8px)] left-0 right-0 bg-white backdrop-blur-xl rounded-[24px] border border-slate-200 shadow-[0_12px_40px_-12px_rgba(0,0,0,0.15)] overflow-hidden z-50 flex flex-col"
          >
              ...
              {!query ? (
                ...
                <div className="space-y-6">
                  {recentSearches.length > 0 && (
                    <div>
                      <div className="px-3 py-2 text-[11px] font-bold uppercase tracking-wider text-slate-400 flex items-center gap-2">
                            ...
                            >
                              ...
                              <div className="flex-1 w-full text-left">
                                <div className="flex flex-col sm:flex-row sm:items-center gap-2 mb-1">
                                  <h4 className="font-bold text-[16px] text-slate-800 group-hover:text-indigo-600 transition-colors">
                                    {result.toolName}
                                  </h4>
            ...
            {!query && (
              <div className="border-t border-slate-100 p-4 bg-slate-50 flex items-center justify-between text-xs font-medium text-slate-400">
