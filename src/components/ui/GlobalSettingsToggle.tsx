  ...
  return (
    <div className="relative z-50" ref={menuRef}>
      <button
        ...
        className="flex items-center gap-1.5 px-3 py-2 rounded-full text-[13px] sm:text-sm font-bold text-slate-600 dark:text-slate-300 hover:text-amber-700 dark:hover:text-amber-400 hover:bg-amber-100/50 dark:hover:bg-amber-900/30 transition-all duration-300 whitespace-nowrap"
      ...
      >
        ...
        <Settings className="w-4 h-4 ml-0.5 text-slate-700 dark:text-slate-300" />
      </button>
