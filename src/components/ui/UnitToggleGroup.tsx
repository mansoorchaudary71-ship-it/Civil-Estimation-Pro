...
export default function UnitToggleGroup({ units, activeUnit, onChange, size = 'md' }: UnitToggleGroupProps) {
  ...
  const inactiveStyle = 'bg-white dark:bg-slate-800 text-slate-700 dark:text-slate-300 hover:text-slate-900 dark:hover:text-slate-100 hover:bg-slate-50 dark:hover:bg-slate-700/50 border-transparent shadow-sm hover:shadow cursor-pointer';
