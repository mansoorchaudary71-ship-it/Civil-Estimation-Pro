    ...
    switch (step) {
      ...
      case 3:
        ...
        return (
          <div className={`space-y-6 transition-all duration-300 ${isTransitioning ? 'opacity-0 translate-x-4' : 'opacity-100 translate-x-0'}`}>
            <div className="text-center">
              <div className="w-16 h-16 bg-blue-100 dark:bg-blue-900/40 text-indigo-600 dark:text-blue-400 rounded-full flex items-center justify-center mx-auto mb-4">
            ...
            <div className="flex flex-col gap-3 py-2">
               {tools.map(t => (
                 <button
                    ...
                    className="flex flex-col items-start p-4 bg-slate-50 dark:bg-indigo-600 border border-slate-100 dark:border-white/5 hover:border-blue-500 dark:hover:border-blue-400  rounded-xl transition-all shadow-sm hover:shadow"
                 >
                    <div className="flex items-center gap-3 mb-1">
                       <div className="p-2 bg-blue-100 dark:bg-blue-900/30 text-indigo-600 dark:text-blue-400 rounded-lg">
