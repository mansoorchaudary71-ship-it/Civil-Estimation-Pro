...
export function ResultCard({
  ...
  const iconColors = {
    primary: 'text-indigo-600 dark:text-indigo-400 bg-indigo-100/80 dark:bg-indigo-900/50',
    secondary: 'text-blue-600 dark:text-blue-400 bg-blue-100/80 dark:bg-blue-900/50',
