          ...
          >
            <div className="p-6">
              ...
              <div className="flex flex-col items-center">
                <div className="bg-white p-3 rounded-2xl shadow-sm border border-slate-100 mb-6 w-fit">
                ...
                <div className="w-full flex items-center gap-2">
                  <div className="relative flex-1">
                    <input
                      ...
                      readOnly
                      value={url}
                      className="w-full pl-4 pr-12 py-3 bg-slate-50 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700 rounded-xl text-sm font-medium text-slate-700 dark:text-slate-300 outline-none truncate"
                    />
                    <button
                      onClick={handleCopy}
