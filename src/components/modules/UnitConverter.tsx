          ...
          {categories.map((c) => {
            ...
            return (
              ...
              >
                ...
                <span className={`text-[11px] sm:text-xs font-extrabold tracking-wide text-center leading-tight ${isActive ? '' : 'text-slate-600 dark:text-slate-400 group-hover:[color:var(--theme-color-hover)]'}`} style={{ color: isActive ? 'var(--theme-color-hover)' : undefined }}>{c.label}</span>
              </button>
            )
          })}
        </div>
