...
export default function GlobalSettingsModal({
  ...
  const InputRow = ({
    ...
    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 px-4 py-3 rounded-[24px] bg-white/50 rounded-[24px] border border-slate-200 shadow-sm text-gray-800 hover:bg-white/80 rounded-[24px] border border-slate-200 shadow-sm text-gray-800 transition-colors border border-transparent hover:border-slate-200 :">
      {" "}
      ...
      <div className="relative flex flex-col w-full sm:w-48">
        ...
        <div className="relative flex items-center w-full">
          ...
          <input
            ...
            className="w-full pl-9 pr-4 py-2 bg-bg-card border border-border-color rounded-[24px] focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500 text-text-primary font-medium transition-shadow"
          />{" "}
        </div>{" "}
      </div>{" "}
    </div>
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
      ...
      <div
        ...
        onClick={onClose}
      ></div>{" "}
      <div className="relative bg-transparent/90 rounded-[24px] border border-slate-200 shadow-sm text-gray-800 backdrop-blur-xl border border-slate-200/50 rounded-[24px] shadow-2xl w-full max-w-lg overflow-hidden flex flex-col max-h-[90vh]">
        {" "}
        {/* Header */}{" "}
        <div className="flex items-center justify-between p-6 border-b border-slate-200/50 shrink-0">
          {" "}
          <div>
            {" "}
            <h3 className="bg-gradient-to-r from-slate-900 to-slate-700 bg-clip-text text-transparent text-lg font-medium text-gray-800 mb-4">
              {" "}
              Global Settings{" "}
            </h3>{" "}
          ...
          <button
            onClick={onClose}
            className="p-2 -mr-2 rounded-full hover:bg-slate-200/50 rounded-[24px] border border-slate-200 shadow-sm text-gray-800 text-gray-700 transition-colors text-base font-semibold"
          >
            {" "}
            <X className="w-5 h-5" />{" "}
          </button>{" "}
        ...
        <div className="p-6 overflow-y-auto flex-1 space-y-2">
          ...
          {activeTab === "prefs" && (
            <div className="space-y-6 animate-in fade-in slide-in-from-bottom-2 duration-300">
              ...
              <div>
                {" "}
                <h4 className="mb-3 flex items-center gap-2 text-lg font-medium text-gray-800 mb-4">
                  {" "}
                  <Ruler className="w-4 h-4 text-gray-700" /> Preferred
                  Units{" "}
                </h4>{" "}
                <div className="space-y-3 bg-white/50 rounded-[24px] border border-slate-200 shadow-sm text-gray-800 px-4 py-3 rounded-[24px] border border-slate-200/50">
                  {" "}
                  <div className="flex items-center justify-between">
                    ...
                    <select
                      ...
                      className="bg-bg-card border border-border-color text-gray-800 rounded-[16px] px-3 py-1.5 focus:outline-none focus:ring-2 focus:ring-blue-500/50 text-sm font-medium"
                    >
                      {" "}
              ...
              <div>
                ...
                <h4 className="mb-3 flex items-center gap-2 text-lg font-medium text-gray-800 mb-4">
                  {" "}
                  <Palette className="w-4 h-4 text-gray-700" /> Default Color
                  Themes{" "}
                </h4>{" "}
                <div className="space-y-3 bg-white/50 rounded-[24px] border border-slate-200 shadow-sm text-gray-800 px-4 py-3 rounded-[24px] border border-slate-200/50">
                  {" "}
        ...
        {/* Footer */}{" "}
        <div className="p-6 border-t border-slate-200/50 shrink-0 bg-slate-100/50 rounded-[24px] border border-slate-200 shadow-sm text-gray-800 flex justify-end gap-3">
          {" "}
          <button
            onClick={onClose}
            className="px-5 py-2.5 rounded-[24px] text-gray-600 hover:bg-slate-200/50 border border-slate-200 shadow-sm text-gray-800 transition-colors text-base font-semibold"
          >
            {" "}
            Cancel{" "}
          </button>{" "}
