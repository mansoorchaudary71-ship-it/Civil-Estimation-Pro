    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
      ...
      <div className="relative bg-transparent/90 rounded-[24px] border border-slate-200 shadow-sm text-slate-800 backdrop-blur-xl border border-slate-200/50 rounded-[24px] shadow-2xl w-full max-w-lg overflow-hidden flex flex-col max-h-[90vh]">
        ...
        <div className="flex items-center justify-between p-6 border-b border-slate-200/50 shrink-0">
          ...
          <button
            onClick={onClose}
            className="p-2 -mr-2 rounded-full hover:bg-slate-200/50 rounded-[24px] border border-slate-200 shadow-sm text-slate-800 text-slate-700 transition-colors"
          >
            {" "}
            <X className="w-5 h-5" />{" "}
          </button>{" "}
                ...
                <div className="space-y-3 bg-[#FAFAF8] hover:bg-[#FDFCF9] transition-colors duration-500/50 rounded-[24px] border border-slate-200 shadow-sm text-slate-800 px-4 py-3 rounded-[24px] border border-slate-200/50">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <select
                      ...
                      className="bg-bg-card border border-border-color text-slate-800 rounded-[16px] px-3 py-1.5 focus:outline-none focus:ring-2 focus:ring-blue-500/50 text-sm font-medium"
                    >
                      {" "}
        ...
        <div className="p-6 border-t border-slate-200/50 shrink-0 bg-slate-100/50 rounded-[24px] border border-slate-200 shadow-sm text-slate-800 flex justify-end gap-3">
          ...
          <button
            onClick={onClose}
            className="px-5 py-2.5 rounded-[24px] text-slate-600 hover:bg-slate-200/50 rounded-[24px] border border-slate-200 shadow-sm text-slate-800 font-medium transition-colors"
          >
            {" "}
            Cancel{" "}
          </button>{" "}
