...
export default function Brickwork9InchModule() {
  ...
  /* m */ const [wallHeight, setWallHeight] = useState<string>("3");
  /* m */ const [deductions, setDeductions] = useState<string>("0");
  /* m2 */ const [mixRatio, setMixRatio] = useState<string>("1:4");
  ...
  return (
    <div className="w-full bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-[1.5rem] overflow-hidden shadow-sm mt-4 flex-1 min-w-fit whitespace-nowrap">
      {" "}
      ...
      <div className="p-6 md:p-8 grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input
                ...
                className="w-full bg-white dark:bg-slate-800/80 border border-slate-200 dark:border-slate-700 text-slate-800 dark:text-white rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-orange-500/50 shadow-sm transition-all flex-1 min-w-fit whitespace-nowrap"
                placeholder="e.g. 5"
              />{" "}
            </div>{" "}
            <div>
          ...
          <div className="grid grid-cols-2 gap-4 border-t border-slate-100 dark:border-slate-800 pt-5">
            ...
            <div>
              {" "}
              <label className="block text-xs font-semibold text-slate-500 uppercase tracking-wider mb-1.5 ml-1 flex items-center gap-1 whitespace-nowrap">
                {" "}
              ...
              <input
                ...
                className="w-full bg-slate-50 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700 text-slate-800 dark:text-white rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-orange-500/50 shadow-sm transition-all flex-1 min-w-fit whitespace-nowrap"
            ...
            <div>
              ...
              <div className="relative">
                ...
                <select
                  ...
                  className="w-full appearance-none bg-slate-50 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700 text-slate-800 dark:text-white rounded-xl px-4 py-3 pr-10 focus:outline-none focus:ring-2 focus:ring-orange-500/50 shadow-sm transition-all cursor-pointer font-medium flex-1 min-w-fit whitespace-nowrap"
                >
                  {" "}
          ...
          <div className="flex items-center gap-3 bg-orange-50/50 dark:bg-orange-900/10 px-4 py-3 rounded-xl border border-orange-100 dark:border-orange-900/30 flex-1 min-w-fit whitespace-nowrap">
            {" "}
            <input
              type="checkbox"
              id="wastage-toggle"
        ...
        {/* Output Section */}{" "}
        <div className="bg-slate-100 dark:bg-slate-800/50 px-4 py-3 md:px-4 py-3 rounded-3xl border border-slate-200 dark:border-slate-700 flex flex-col justify-center flex-1 min-w-fit whitespace-nowrap">
          {" "}
          <div className="mb-8">
            {" "}
            <p className="text-sm font-semibold text-slate-500 uppercase tracking-widest mb-2 whitespace-nowrap">
              Net Wall Volume
            </p>{" "}
            <div className="flex items-baseline gap-2 text-slate-800 dark:text-white">
              ...
              <span className="text-xl font-bold text-slate-500 whitespace-nowrap">
                m³
              </span>{" "}
            </div>{" "}
          </div>{" "}
          <div className="flex flex-wrap sm:gap-4 items-center w-full">
            {" "}
            <div className="bg-white dark:bg-slate-800 px-4 py-3 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-700 flex-1 min-w-fit whitespace-nowrap">
              {" "}
            ...
            <div className="bg-white dark:bg-slate-800 px-4 py-3 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-700 sm:col-span-2 flex-1 min-w-fit whitespace-nowrap">
              {" "}
              <div className="flex items-center gap-2 mb-3">
                {" "}
          ...
          <div className="mt-6 flex items-center gap-2 text-xs font-semibold text-slate-400 bg-slate-200/50 dark:bg-slate-800 p-3 rounded-lg">
            ...
            {results.dryMortarVol.toFixed(3)} m³ | Wet:{" "}
            {results.wetMortarVol.toFixed(3)} m³{" "}
          </div>{" "}
        </div>{" "}
      </div>{" "}
    </div>
