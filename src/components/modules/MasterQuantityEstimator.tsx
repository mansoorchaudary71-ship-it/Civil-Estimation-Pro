          ...
          <div className="w-full lg:w-80 flex-shrink-0 space-y-4">
            <div className="relative">
              <input
                ...
                className="w-full bg-[#FAFAF8] hover:bg-[#FDFCF9] transition-colors duration-500 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 px-4 py-3 rounded-[24px] shadow-sm focus:ring-2 focus:ring-indigo-500 font-medium outline-none placeholder:text-slate-400"
              />
            </div>
            ...
            <div className="xl:h-[600px] xl:overflow-y-auto pr-2 space-y-4 custom-scrollbar">
              {groups.map((group) => {
                ...
                return (
                  <div key={group} className="bg-[#FAFAF8] hover:bg-[#FDFCF9] transition-colors duration-500 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-[24px] overflow-hidden shadow-[0_4px_24px_rgba(15,23,42,0.02)]">
                    <button
          ...
          <div className="flex-1">
            {activeCalculator ? (
               <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 w-full items-start">
                 <div className="lg:col-span-4 bg-[#FAFAF8] hover:bg-[#FDFCF9] transition-colors duration-500 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-[24px] px-6 py-6 shadow-[0_4px_24px_rgba(15,23,42,0.02)]">
