...
export default function BeamDesignTool() {
  ...
  return (
    <div className="flex flex-col gap-8 w-full max-w-4xl mx-auto">
      <div className="bg-white rounded-[24px] p-6 md:p-8 shadow-sm border border-slate-200">
         ...
         <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <input type="number" className="w-full bg-slate-50 border border-slate-200 rounded-[24px] px-4 py-3" value={span} onChange={e => setSpan(e.target.value)} />
            </div>
            <div>
            ...
            <div>
              ...
              <select className="w-full bg-slate-50 border border-slate-200 rounded-[24px] px-4 py-3" value={fck} onChange={e => setFck(e.target.value)}>
            ...
            <div>
              ...
              <select className="w-full bg-slate-50 border border-slate-200 rounded-[24px] px-4 py-3" value={fy} onChange={e => setFy(e.target.value)}>
      ...
      <div className="bg-pink-50 rounded-[24px] p-6 md:p-8 border border-pink-100">
         <h3 className="text-lg font-bold text-pink-800 mb-4">Design Results</h3>
