          ...
          <div className="w-full md:w-[45%] flex flex-col gap-6">
            <div className="bg-white dark:bg-slate-900 p-6 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm relative overflow-hidden">
              ...
              <div className="mb-6 z-10 relative">
                ...
                {testData.length <= 3 && (
                   <p className="text-[10px] text-slate-400 mt-2 font-medium">Minimum of 3 samples required for accurate Coulomb regression.</p>
                )}
              </div>
              ...
              <button
                ...
                className="w-full mt-6 bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-3.5 px-6 rounded-xl shadow-md shadow-indigo-200 dark:shadow-none transition-all flex justify-center items-center gap-2 group border border-indigo-500 disabled:opacity-60"
              >
            ...
            <div className="bg-white dark:bg-slate-900 p-5 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm">
              ...
              <div className="space-y-3">
                <div className="p-3 bg-slate-50 dark:bg-slate-800/50 rounded-xl border border-slate-100 dark:border-slate-700/50">
                  <p className="font-bold text-xs text-slate-700 dark:text-slate-300 mb-1">What if cohesion comes out negative?</p>
                  <p className="text-[11px] text-slate-500 dark:text-slate-400">Theoretically, soil cannot have negative cohesion. We bound the bottom limit of 'c' to 0 if the linear fit forces a negative intercept.</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="w-full md:w-[55%]">
            {isProcessing ? (
              ...
              <div className="space-y-6">
                <div className="bg-white dark:bg-slate-900 p-6 md:p-8 rounded-[2rem] border border-slate-200 dark:border-slate-800 shadow-lg relative overflow-hidden transition-all duration-500">
