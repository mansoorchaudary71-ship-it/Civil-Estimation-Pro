          ...
          <div className="p-6 md:p-8 space-y-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div className="space-y-6">
                ...
                <div>
                  <h3 className="font-bold text-lg mb-4 text-slate-800 border-b border-slate-100 pb-2">Column & Earthworks</h3>
                ...
                <div>
                  <h3 className="font-bold text-lg mb-4 text-slate-800 border-b border-slate-100 pb-2">Reinforcement Mesh</h3>
                    ...
                    <div className="p-4 bg-slate-50 rounded-[24px] border border-slate-200 shadow-sm text-slate-800">
                      ...
                      <div className="space-y-4">
                        ...
                        <InputGroup label="Spacing c/c (mm)">
                           <NumberInput className="w-full calc-input px-3 py-2 text-sm shadow-sm transition-all" value={spacingX} onChange={(val) => setSpacingX(val.toString())} />
                        </InputGroup>
                      </div>
                    </div>
                    <div className="p-4 bg-slate-50 rounded-[24px] border border-slate-200 shadow-sm text-slate-800">
                      ...
                      <div className="space-y-4">
                        ...
                        <InputGroup label="Spacing c/c (mm)">
                           <NumberInput className="w-full calc-input px-3 py-2 text-sm shadow-sm transition-all" value={spacingY} onChange={(val) => setSpacingY(val.toString())} />
                        </InputGroup>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="mt-4">
                    <label className="flex items-center gap-3 cursor-pointer p-4 bg-slate-100 border border-slate-200 rounded-[24px]">
                      ...
                      <span className="font-bold text-slate-800">Include Top Mesh</span>
                    </label>
                  </div>
                    ...
                    <div className="grid grid-cols-2 gap-4 mt-4 animate-in fade-in slide-in-from-top-2 duration-300">
                      <div className="p-4 bg-indigo-50/50 rounded-[24px] border border-indigo-100">
                        ...
                        <div className="space-y-4">
                          ...
                          <InputGroup label="Spacing c/c (mm)">
                             <NumberInput className="w-full calc-input px-3 py-2 text-sm shadow-sm transition-all" value={spacingXTop} onChange={(val) => setSpacingXTop(val.toString())} />
                          </InputGroup>
                        </div>
                      </div>
                      <div className="p-4 bg-indigo-50/50 rounded-[24px] border border-indigo-100">
                        ...
                        <div className="space-y-4">
                          ...
                          <InputGroup label="Spacing c/c (mm)">
                             <NumberInput className="w-full calc-input px-3 py-2 text-sm shadow-sm transition-all" value={spacingYTop} onChange={(val) => setSpacingYTop(val.toString())} />
                          </InputGroup>
                        </div>
                      </div>
                    </div>
                  ...
                  <div>
                    ...
                    <div className="bg-slate-50 border border-slate-200 rounded-[24px] overflow-hidden shadow-sm">
                      <div className="p-4 bg-slate-100 border-b border-slate-200 flex justify-between items-center">
                        <span className="font-bold text-slate-700">Total Steel Required</span>
