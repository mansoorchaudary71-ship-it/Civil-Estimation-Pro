    ...
    <div className="w-full h-full overflow-y-auto bg-transparent text-gray-900 font-sans p-6 md:p-8">
      ...
      <div className="hidden print:block p-8 bg-white text-black" ref={printRef}>
         <div className="border-b-2 border-slate-800 pb-4 mb-6">
            <h1 className="text-2xl font-bold tabular-nums tracking-tight uppercase text-slate-900">Bar Bending Schedule</h1>
         ...
         <table className="w-full text-sm text-left border-collapse border border-slate-300">
           ...
           <tbody>
             ...
             <tr className="bg-slate-50">
               ...
               <td className="px-3 py-3 border border-slate-300 text-right font-bold tabular-nums tracking-tight text-lg">{totalProjectWeight.toFixed(2)} kg</td>
             </tr>
           </tbody>
         </table>
      </div>
