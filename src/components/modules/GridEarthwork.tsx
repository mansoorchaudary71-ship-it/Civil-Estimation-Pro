          ...
          <section className="space-y-6">
            ...
            <div className="bg-white px-4 py-3 rounded-[1.5rem] shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100 transition-all hover:shadow-[0_8px_30px_rgb(0,0,0,0.08)] flex-1 min-w-fit whitespace-nowrap">
              ...
              <div className="grid grid-cols-2 gap-6 relative">
                ...
                {/* Top Left */}{" "}
                <div className="bg-white border-2 border-gray-100 px-4 py-3 rounded-2xl relative z-10 shadow-sm hover:border-blue-200 transition-colors flex-1 min-w-fit whitespace-nowrap">
                  {" "}
                  ...
                  <div className="space-y-3">
                    ...
                    <div>
                      {" "}
                      <label className="block text-xs font-semibold text-gray-500 uppercase tracking-wider mb-1 whitespace-nowrap">
                        Existing
                      </label>{" "}
                      <input
                        type="number"
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-white/10 p-5 rounded-[1.25rem] border border-white/20 backdrop-blur-sm">
                    ...
                    <div className="text-2xl font-bold text-white whitespace-nowrap">
                      ...
                      <span className="opacity-70 text-lg whitespace-nowrap">
                        {unitL}
                      </span>{" "}
                    </div>{" "}
                  </div>{" "}
                  ...
                  <div className="p-5 rounded-[1.25rem] border bg-white/20 border-white/30 backdrop-blur-sm mt-6">
                    ...
                    <div className="flex justify-between items-end mb-2">
                      ...
                      <div className="text-white font-bold text-xl uppercase tracking-wider whitespace-nowrap">
                        {" "}
                        {isCut ? "CUT" : isFill ? "FILL" : "LEVEL"}{" "}
                      </div>{" "}
                    </div>{" "}
                    <div className="text-4xl font-black tracking-tight text-white mb-4 whitespace-nowrap">
                      {" "}
                      {Math.abs(avgDepth).toFixed(3)}{" "}
                      <span className="text-xl font-medium opacity-80 whitespace-nowrap">
                        {unitL}
                      </span>{" "}
                    </div>{" "}
                    ...
                    <div className="text-5xl font-black tracking-tighter text-white whitespace-nowrap">
                      {" "}
                      {totalVolume.toFixed(2)}{" "}
                      <span className="text-2xl font-medium opacity-80 whitespace-nowrap">
                        {unitV}
                      </span>{" "}
                    </div>{" "}
                  </div>{" "}
