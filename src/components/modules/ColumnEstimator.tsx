                    ...
                    <div className="flex-1">
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        <div className="bg-white/60 dark:bg-slate-900/40 p-4 rounded-xl border border-amber-100 dark:border-amber-900/50">
                          ...
                          <span className="text-xl md:text-2xl font-semibold tabular-nums tracking-tight text-slate-800 dark:text-slate-100">{(elementWeightKg / 1000).toFixed(2)}<span className="text-sm font-medium ml-1 text-slate-500">Tons</span></span>
                        </div>
                        <div className="bg-white/80 dark:bg-slate-900/60 p-4 rounded-xl border border-amber-200 dark:border-amber-800/50 shadow-sm">
                          ...
                          <span className="text-xl md:text-2xl font-semibold tabular-nums tracking-tight text-amber-700 dark:text-amber-400">{craneCapacityTonnes.toFixed(2)}<span className="text-sm font-medium ml-1 text-amber-600/80 dark:text-amber-500/80">Tons</span></span>
                        </div>
                      </div>
                    </div>
                  </div>
