  ...
  return (
    <div className="w-full max-w-4xl mx-auto space-y-6">
      <div className="bg-white border border-slate-200 p-6 rounded-[24px] shadow-sm">
        ...
        <p className="mb-6 text-base font-normal text-gray-600 leading-relaxed">Estimate minimum required boundary margins per typical NBC guidelines based on plot size.</p>

        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-8">
          <div>
            <label className="block mb-2 text-sm font-medium text-gray-700 mb-1">Plot Frontage (m)</label>
          ...
          <div>
            <label className="block mb-2 text-sm font-medium text-gray-700 mb-1">Plot Depth (m)</label>
          ...
          <div>
            <label className="block mb-2 text-sm font-medium text-gray-700 mb-1">Total Plot Area (m²)</label>
          ...
          <div>
            <label className="block mb-2 text-sm font-medium text-gray-700 mb-1">Building Type</label>
          ...
          <div>
            <label className="block mb-2 text-sm font-medium text-gray-700 mb-1">Approach Road Width (m)</label>
        ...
        <div className="relative w-full h-64 bg-slate-100 border border-slate-200 mb-8 flex items-center justify-center rounded-[24px] overflow-hidden">
           <div className="absolute top-2 text-xs font-bold text-gray-600">Rear Setback: {rearSetback}m</div>
           <div className="absolute bottom-2 text-xs font-bold text-gray-600">Front Setback: {frontSetback}m &darr; Road {roadWidth}m Wide</div>
           <div className="absolute left-2 text-xs font-bold text-gray-600" style={{writingMode: 'vertical-rl'}}>Side: {sideMargin}m</div>
           <div className="absolute right-2 text-xs font-bold text-gray-600" style={{writingMode: 'vertical-rl'}}>Side: {sideMargin}m</div>
