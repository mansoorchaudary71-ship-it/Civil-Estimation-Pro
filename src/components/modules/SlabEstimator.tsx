        ...
        <div className="bg-white rounded-3xl shadow-sm border border-slate-200 p-6 md:p-8">
          ...
          <div className="mb-6 p-1 bg-slate-100 rounded-xl flex gap-1">
            <button
              ...
              className={`flex-1 py-2 rounded-lg text-sm font-bold transition-all ${slabType === "one-way" ? "bg-white shadow-sm text-blue-600" : "text-slate-500 hover:text-slate-700 hover:bg-slate-200/50"}`}
            >
              One-Way Slab
            </button>
            <button
              onClick={() => setSlabType("two-way")}
              className={`flex-1 py-2 rounded-lg text-sm font-bold transition-all ${slabType === "two-way" ? "bg-white shadow-sm text-blue-600" : "text-slate-500 hover:text-slate-700 hover:bg-slate-200/50"}`}
            >
              Two-Way Slab
            </button>
          </div>
