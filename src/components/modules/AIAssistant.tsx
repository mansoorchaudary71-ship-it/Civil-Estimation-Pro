...
export default function AIAssistant() {
  const [messages, setMessages] = useState<Message[]>([
    {
      role: "model",
      content: "Hello! I am your AI-powered Civil Engineering Estimator. Describe your project requirements (e.g., 'Estimate materials for a 10x10 room with a 10ft ceiling'), and I will provide a preliminary cost and material breakdown using NLP extraction."
    }
  ]);
  ...
  const handleSend = async () => {
    ...
    try {
      ...
      setMessages((prev) => [
        ...prev,
        { role: "model", content: "Error executing estimation. Please check your API key configuration and try again." }
      ]);
    } finally {
      setIsLoading(false);
    }
