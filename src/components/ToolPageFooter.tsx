    ...
    <div className="w-full bg-white rounded-[32px] p-6 md:p-8 border border-slate-100 shadow-sm space-y-3">
      ...
      <div className="bg-[#FFFFFF] border border-slate-200 rounded-xl p-5 shadow-sm">
        ...
        <div className="bg-[#FFFFFF] rounded-lg p-4 mb-4 border border-slate-200">
          <p className="font-mono whitespace-pre-wrap text-base font-normal text-gray-600 leading-relaxed">
            {formulaDescription}
          </p>
        </div>
        <div className="flex flex-wrap gap-2">
          {standards.length > 0 ? (
            standards.map((standard, index) => (
              <div
                key={index}
                className="flex items-center gap-1.5 bg-white/50 border border-slate-200 text-gray-700 px-3 py-1.5 rounded-full text-xs font-semibold"
              >
            ...
            <div className="text-xs text-gray-500 font-medium">Standard general practice formulas applied</div>
          )}
        </div>
      </div>
      ...
      <div className="bg-[#FFFFFF] border border-amber-200 rounded-xl p-5 flex gap-4 items-start">
        ...
        <div>
          <h4 className="text-[#F59E0B] uppercase r mb-1 text-lg font-medium text-gray-800 mb-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
        <div className="bg-[#FFFFFF] border border-slate-200 rounded-lg p-4 flex items-center gap-3">
          ...
          <div>
            <p className="uppercase tracking-wider text-base font-normal text-gray-600 leading-relaxed">Last Reviewed</p>
            <p className="mt-0.5 text-base font-normal text-gray-600 leading-relaxed">{lastUpdated}</p>
          </div>
        </div>
        <div className="bg-[#FFFFFF] border border-slate-200 rounded-lg p-4 flex items-center gap-3">
          <ShieldCheck className="w-5 h-5 text-gray-500" />
          <div>
            <p className="uppercase tracking-wider text-base font-normal text-gray-600 leading-relaxed">Complexity</p>
            <p className="mt-0.5 text-base font-normal text-gray-600 leading-relaxed">{difficulty}</p>
          </div>
        </div>
        <div className="bg-[#FFFFFF] border border-slate-200 rounded-lg p-4 flex items-center gap-3">
          <Globe className="w-5 h-5 text-gray-500" />
          <div>
            <p className="uppercase tracking-wider text-base font-normal text-gray-600 leading-relaxed">Platform Category</p>
            <p className="mt-0.5 text-base font-normal text-gray-600 leading-relaxed">{category}</p>
          </div>
        </div>
      </div>
      ...
      {standards.length > 0 && (
        <div className="border border-slate-200 rounded-xl p-5 bg-[#FFFFFF]/50">
          <h4 className="mb-3 text-lg font-medium text-gray-800 mb-4">Official Standards References</h4>
