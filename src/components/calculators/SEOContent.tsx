...
export function SEOContent({ category, data }: SEOContentProps) {
  const renderMetalContent = () => (
    <>
      <h2 className="text-3xl font-semibold text-slate-900 mt-8 mb-4">How to Calculate Weight for {data.diameter_mm}mm {data.profile}</h2>
      <p className="mb-4">
  ...
  const renderConcreteContent = () => (
    <>
      <h2 className="text-3xl font-semibold text-slate-900 mt-8 mb-4">How to Calculate Material for {data.volume_cft} CFT</h2>
      <p className="mb-4">
  ...
  const renderHouseContent = () => (
    <>
      <h2 className="text-3xl font-semibold text-slate-900 mt-8 mb-4">How to Calculate Grey Structure Cost for {data.plot_designation}</h2>
      <p className="mb-4">
  ...
  const renderEarthworksContent = () => (
    <>
      <h2 className="text-3xl font-semibold text-slate-900 mt-8 mb-4">How to Calculate Excavation Hauling using {data.calculation_method}</h2>
      <p className="mb-4">
  ...
  return (
    <article className="prose prose-indigo max-w-none text-slate-600 mt-8 font-sans">
      <h1 className="text-3xl font-semibold tracking-tight text-slate-900 tracking-tight capitalize mb-2 border-b pb-4">
        {data.target_keyword}
      </h1>
      ...
      <h3 className="text-xl font-semibold text-slate-900 mt-8 mb-3">Standard Allowances and Wastage Factors</h3>
      <p>
